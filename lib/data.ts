...
export const skills = [
     { name: "React", icon: "/linguagens/react.svg" },
     { name: "Next.js", icon: "/linguagens/nodedotjs.svg" },
     { name: "TypeScript", icon: "/linguagens/typescript.svg" },
     { name: "JavaScript", icon: "/linguagens/javascript.svg" },
     { name: "Python", icon: "/linguagens/python.svg" },
